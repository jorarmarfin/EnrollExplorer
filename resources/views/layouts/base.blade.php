...
<head><base href="../"/>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Sistemas de credenciales" />
    <meta name="keywords" content="uni" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="es_ES" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Uni" />
    <meta property="og:url" content="http://admision.uni.edu.pe" />
    <meta property="og:site_name" content="Admision" />
    <link rel="canonical" href="http://admision.uni.edu.pe" />
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside overflow-visible overflow-lg-auto bg-primary" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
            ...
            <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-8" id="kt_aside_logo">
                <a href="/">
                    <img alt="Logo" src="{{asset('assets/media/logos/logo1.png')}}" class="h-55px" />
                </a>
            </div>
            <!--end::Logo-->
            @include('menu.main')
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="/" class="d-lg-none">
                            <img alt="Logo" src="{{asset('assets/media/logos/logo1.png')}}" class="h-25px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                    <div class="d-flex align-items-center" id="kt_header_wrapper">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                            <!--begin::Heading-->
                            <h1 class="text-dark fw-bold my-1 fs-3 lh-1">{{env('APP_NAME')}}</h1>
                            <!--end::Heading-->
                        </div>
                        <!--end::Page title=-->
                    </div>
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        ...
                        <div class="d-flex align-items-stretch justify-self-end flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3">
                                <h3>{{auth()->user()?->nombre_dependencia}}</h3>
                                <!--begin::Menu toggle-->
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <img src="{{asset('assets/media/logos/logo1.png')}}" alt="user" />
                                </div>
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                <div class="@yield('container-class','container-xxl')" id="kt_content_container">
                    @yield('content')
                </div>
            </div>
            <!--end::Content-->
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-xxl d-flex flex-column flex-md-row flex-stack">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="https://keenthemes.com" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6">DIAD</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
                    <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                        <li class="menu-item">
                            <a href="http://admision.uni.edu.pe/" target="_blank" class="menu-link px-2">Dirección de admisión</a>
                        </li>
                    </ul>
                    <!--end::Menu-->
                </div>
